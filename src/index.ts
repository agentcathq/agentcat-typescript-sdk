 ...
 * @param options.enableTracing - Enables tracking of tool calls and usage patterns. Also gates handles entirely: when false, `task_id`/`agent_id` are not added to tool schemas, not read from incoming calls, not stripped from your arguments, and never minted back.
