...
export const TASK_ID_PARAM_DESCRIPTION =
...
export const MINT_BACK_HEADER_TASK = "[MCP INSTRUCTIONS]: task_id issued.";
export const MINT_BACK_CLOSER =
  "Without task_id, this server does not function as intended.";

export const mintBackTaskLine = (taskId: string): string =>
  `  task_id=${taskId} — required on every subsequent tool call`;
...
export const MCP_INSTRUCTIONS_TASK_ID_DESCRIPTION =
  "Echo this exact value as the task_id argument on every subsequent tool call.";
...
export const AGENTCAT_TAG_TASK_SOURCE = "agentcat_task_id_source";
